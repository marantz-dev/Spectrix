...
def generate_spectrix_report(dry_file, proc1_file, proc2_file):
    ...
    plt.savefig(
        "/Users/riccardomarantonio/dev/university/Tesi_Triennale/immagini/spectrix_report1.pdf",
        format="pdf",
        bbox_inches="tight",
    )
    # plt.show()
...
if __name__ == "__main__":
    if len(sys.argv) < 4:
        print(
            "Utilizzo: python spectrix_analyzer.py <dry.wav> <processed1.wav> <processed2.wav>"
        )
    else:
